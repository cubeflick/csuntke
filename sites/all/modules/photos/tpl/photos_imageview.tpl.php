 ...
 */
  ...
  if (isset($image->ajax['edit_url'])) {
    ...
    $filename_edit = ' id="photos-image-edit-filename-' . $image->fid . '"';
...
<?php if($type == 'list') : ?>
  <div class="photos_image_list_view" <?php print $ajax_delete_id; ?>>
    ...
    <?php 
      print '<h2 class="photos_list_view_filename' . $name_class . '"' . $filename_edit . '>';
...
<?php if($type == 'view') : ?>
  <div id="image-load" class="image-load">
    <?php
      print '<h2 class="photos_view_filename' . $name_class . '"' . $filename_edit . '>';
      print $image->filename;
      print '</h2>';
    ?>
