...
<?php
  ...
  $alt = isset($image->alt) ? strip_tags($image->alt) : $filename;
...
<?php else: ?>
    <div class="photos_imagehtml">
      ...
      <?php if(isset($image->colorbox)): ?>
        <a class="photos_imagehtml_colorbox colorbox" rel="colorbox_<?php print $image->pid; ?>" href="<?php print _photos_l($image->uri, 'origianl'); ?>" title="<?php print $filename; ?>">view original</a>
      <?php endif; ?>
    </div>
<?php endif; ?>